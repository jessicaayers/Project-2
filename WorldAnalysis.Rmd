...
lmFit1Pred <- predict(lmFit1, newdata = worldTest)
lm1 <- postResample(lmFit2Pred, worldTest$shares)
```
...
boosted_tree <- postResample(boosted_tree_predictions, worldTest$shares)
boosted_tree
```
